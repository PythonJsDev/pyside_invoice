...
class FormClient(QtWidgets.QWidget):
    ...
    def add_widgets_to_layouts(self):
        ...
        # row 2
        self.main_layout.addWidget(self.lbl_civil_title, row+2, column, row_span, column_span)
        self.main_layout.addWidget(self.cbox_civil_title, row+2, column+1, row_span, column_span*4)
        # row 3
        self.main_layout.addWidget(self.lbl_client_last_name, row+3, column, row_span, column_span)
        self.main_layout.addWidget(self.le_client_last_name, row+3, column+1, row_span, column_span*4)
        # row 4
        self.main_layout.addWidget(self.lbl_client_first_name, row+4, column, row_span, column_span)
        self.main_layout.addWidget(self.le_client_first_name, row+4, column+1, row_span, column_span*4)
        # row 5
        self.main_layout.addWidget(self.lbl_email, row+5, column, row_span, column_span)
        self.main_layout.addWidget(self.le_email, row+5, column+1, row_span, column_span*4)
        # row 6
        self.main_layout.addWidget(self.lbl_phone, row+6, column, row_span, column_span)
        self.main_layout.addWidget(self.le_phone, row+6, column+1, row_span, column_span*4)
        # row 7
        self.main_layout.addWidget(self.lbl_address, row+7, column, row_span, column_span*5, QtCore.Qt.AlignCenter)
        # row 8
        self.main_layout.addWidget(self.lbl_place, row+8, column, row_span, column_span)
        self.main_layout.addWidget(self.le_place, row+8, column+1, row_span, column_span*4)
        # row 9
        ...
        # row 11
        self.main_layout.addWidget(self.hline_bottom, row+11, column, row_span, column_span*5)
        # row 13
